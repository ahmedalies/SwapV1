...
let UserItemController = class UserItemController {
    constructor(service) {
        this.service = service;
    }
    addItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.service.addItem(req.body, req.headers)
                .then((r) => {
...
UserItemController = __decorate([
    ...
    __metadata("design:paramtypes", [UserItemService_1.UserItemService])
], UserItemController);
exports.UserItemController = UserItemController;
//# sourceMappingURL=UserItemController.js.map