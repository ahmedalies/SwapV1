...
let MongoORMRepository = class MongoORMRepository {
    ...
    findByTwoKeys(queryElement, model) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield new Promise((resolve, reject) => {
                model.getModel().findOne(queryElement)
                    .then((res) => {
...
MongoORMRepository = __decorate([
    inversify_1.injectable()
], MongoORMRepository);
exports.MongoORMRepository = MongoORMRepository;
