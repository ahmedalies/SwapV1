...
let ORMRepostory = class ORMRepostory {
    constructor(mysql, mongo) {
        this.mysql = mysql;
        this.mongo = mongo;
    }
};
ORMRepostory = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject('MysqlORMRepository<DALEntity>')),
    __param(1, inversify_1.inject('MongoORMRepository<DALEntity>')),
    __metadata("design:paramtypes", [MysqlORMRepository_1.MysqlORMRepository,
        MongoORMRepository_1.MongoORMRepository])
], ORMRepostory);
exports.ORMRepostory = ORMRepostory;
